...
def plot_contour(of_vals, lt_vals, Z_pct, output_path="humbird_construction_share_contour.png"):
    ...
    ax.plot(0.96, 30, marker="*", markersize=14, color="white",
            markeredgecolor="black", markeredgewidth=0.8, zorder=5,
            label="Base case (OF=0.96, LT=30 yr)")
    ...
    ax.set_title(
        "Humbird (2011) — Construction Phase Share of Total Lifecycle CO₂e Emissions\n"
        f"Construction = {CONSTRUCTION_G:.4e} gCO₂e  |  "
        f"Ethanol: 61 MM gal/yr @ 96% uptime  |  EF = {EF_G_PER_MJ} gCO₂e/MJ",
        fontsize=9,
    )
